...
public class QueryTerm extends QueryCommon {
    ...
    public static void search() {
        SearchResponse response = ClientInstance.getClient()
                ...
                //内容：上海中环保时捷狂飙 英菲尼迪时速180公里跟拍，分词：standard（每个词一个term，另外保存一份原始文本）
                // 搜索“中华”是搜不到的，因为term查询必须要完全匹配，
                //上面的那句话是standard分词的，分出来每个词一个term，所以没有警察这个term，找不到
                //如果是送搜索“中”是可以搜索到的，因为分词出来有“中”这个字
                //查看分词情况可以这么看
                //http://192.168.200.9:9200/drp/_analyze?analyzer=standard&pretty&text=上海中环保时捷狂飙 英菲尼迪时速180公里跟拍
